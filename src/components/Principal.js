...
export const Principal = (props) => {
  ...
  var h = ahora.getHours() <= 19 ? "0" : "1";
  const codigo = props.values.weatherCodeFullDay + h;
  const logo = "./icons/png/" + codigo + ".png";
  return (
    <div className="CardMain">
      <img src={logo} className="imgMain vertical-shake" alt="logo" />
      ...
      <div className="Informacion">
        ...
        <div className="Info">
          <div className="Info1">
            <p>Nube ↑: {props.values.cloudCeiling}KM</p>
            <p>Nube ↓: {props.values.cloudBase}KM</p>
            <p>Humedad: {props.values.humidity}%</p>
          </div>
          <div className="Info2">
            <p>Dirección del viento: {props.values.windDirection}°</p>
            <p>Velocidad del viento: {props.values.windSpeed}m/s</p>
            <p>Precipitación: {props.values.precipitationType}</p>
          </div>
          <div className="Info3">
            <p>Temperatura maxima: {props.values.temperatureMax}°C</p>
            <p>Temperatura minima: {props.values.temperatureMin}°C</p>
            <p>Temperatura aparente: {props.values.temperatureApparent}°C</p>
          </div>
        </div>
      </div>
    </div>
